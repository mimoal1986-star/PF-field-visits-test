            ...
            if not display_data.empty:
                ...
                with st.expander("👀 Просмотреть таблицу", expanded=False):
                    ...
                    display_columns = [
                        ...
                        'План проекта, шт.', 'Факт проекта, шт.', '△План/Факт проекта, шт.', '%ПФ проекта',
                        'Прогноз на месяц, шт.', 'Прогноз на месяц, %',
                        'Кол-во визитов до 100% плана, шт.', 'Поручено', 'Доля Поручено, %',
                        'Длительность проекта, кол-во дней', 'Дней потрачено',
                        'Дней до конца проекта', 'Ср. план на день для 100% плана',
                        'Исполнение Проекта,%', 'Утилизация тайминга, %', 'Фокус'
                    ]
