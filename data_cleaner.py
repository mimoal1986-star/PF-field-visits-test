...
class DataCleaner:
    ...
    def check_problematic_projects(self, google_df, autocoding_df, array_df):
        ...
        columns = [
            ...
            portal_col,
            'Код проекта пусто', 'Проекта НЕТ в АК', 'Проект не полевой', 'проекта нет в массиве'
        ]
        ...
        check_columns = ['Код проекта пусто', 'Проекта НЕТ в АК', 'Проект не полевой', 'проекта нет в массиве']
