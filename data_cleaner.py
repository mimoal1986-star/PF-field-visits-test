...
REGION_MAPPING = {
    ...
    'MC': 'Московская область','ZK': 'Забайкальский край'
}
...
class DataCleaner:
    ...
    def clean_cxway(self, df, hierarchy_df, google_df):
        ...
        region_mapping = {
            ...
            'VO': 'Вологодская область', 'VR': 'Воронежская область', 'YN': 'Ямало-Ненецкий автономный округ',
            'YS': 'Ярославская область', 'YV': 'Еврейская автономная область', 'ZO': 'Запорожская область',
            'DN': 'Донецкая Народная Республика','LG': 'Луганская Народная Республика','ZO': 'Запорожская область',
            'MC': 'Московская область','ZK': 'Забайкальский край'
        }
    ...
    def clean_prodata(self, df, google_df):
        ...
        full_region_names = {
            ...
            'UL': 'Ульяновская область', 'VG': 'Волгоградская область', 'VL': 'Владимирская область',
            'VO': 'Вологодская область', 'VR': 'Воронежская область', 'YN': 'Ямало-Ненецкий автономный округ',
            'YS': 'Ярославская область', 'YV': 'Еврейская автономная область', 'DN': 'Донецкая Народная Республика',
            'LG': 'Луганская Народная Республика','ZO': 'Запорожская область','MC': 'Московская область','ZK': 'Забайкальский край'
            }
